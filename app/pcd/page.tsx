...
const ProductCard = ({ product, index }: { product: Product; index: number }) => {
  ...
  const getImagePath = (code: string) => {
    // Adicione aqui a lógica para buscar imagens dos produtos PCD
    // Por exemplo, se houver uma pasta PCD com imagens:
    // return `/PCD/${code}.png`;
    return null;
  };
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-gray-200 max-w-3xl mx-auto mb-8">
              {pcdData.subtitle || "Ferramentas de Diamante Policristalino"}
            </p>
            <div className="flex items-center justify-center gap-4 text-sm text-gray-300 flex-wrap">
              <div className="flex items-center gap-2">
                <Shield className="w-5 h-5" />
                <span>Ultra-precisão</span>
              </div>
              <div className="flex items-center gap-2">
                <Zap className="w-5 h-5" />
                <span>Máxima vida útil</span>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              {pcdData.name || "PCD/PDC"} - {pcdData.subtitle || "Ferramentas de Diamante Policristalino"}
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              {pcdData.shortDesc || pcdData.fullDesc || "As ferramentas de diamante policristalino (PCD - Polycrystalline Diamond) e diamante policristalino compacto (PDC - Polycrystalline Diamond Compact) representam o estado da arte em materiais para ferramentas de corte, combinando a dureza extrema do diamante com a tenacidade de um material policristalino sinterizado."}
            </p>
            {pcdData.fullDesc && (
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  {pcdData.applications && pcdData.applications.length > 0 ? (
                    pcdData.applications.map((app: string, idx: number) => (
                    ...
                    <>
                      <li className="flex items-center">
                        <div className="w-1.5 h-1.5 bg-[#15297c] rounded-full mr-2" />
                        Torneamento de alta velocidade de alumínio e ligas leves
                      </li>
                      <li className="flex items-center">
                        <div className="w-1.5 h-1.5 bg-[#15297c] rounded-full mr-2" />
                        Usinagem de materiais compósitos reforçados com fibra
                      </li>
                      <li className="flex items-center">
                        <div className="w-1.5 h-1.5 bg-[#15297c] rounded-full mr-2" />
                        Fresamento de precisão de materiais não-ferrosos
                      </li>
                      <li className="flex items-center">
                        <div className="w-1.5 h-1.5 bg-[#15297c] rounded-full mr-2" />
                        Usinagem de plásticos técnicos e polímeros reforçados
                      </li>
                    </>
                  )}
                </ul>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Benefícios Principais</h3>
                <ul className="space-y-2 text-gray-700">
                  {pcdData.benefits && pcdData.benefits.length > 0 ? (
                    pcdData.benefits.map((benefit: string, idx: number) => (
                      <li key={idx} className="flex items-center">
                        <div className="w-1.5 h-1.5 bg-[#15297c] rounded-full mr-2" />
                        {benefit}
                      </li>
                    ...
                    <>
                      <li className="flex items-center">
                        <div className="w-1.5 h-1.5 bg-[#15297c] rounded-full mr-2" />
                        Vida útil até 100 vezes superior às ferramentas convencionais
                      </li>
                      <li className="flex items-center">
                        <div className="w-1.5 h-1.5 bg-[#15297c] rounded-full mr-2" />
                      ...
                      <li className="flex items-center">
                        <div className="w-1.5 h-1.5 bg-[#15297c] rounded-full mr-2" />
                        Altas velocidades de corte e produtividade elevada
                      </li>
                      <li className="flex items-center">
                        <div className="w-1.5 h-1.5 bg-[#15297c] rounded-full mr-2" />
                        Resistência ao desgaste isotrópica em todas as direções
                      </li>
                    </>
                  )}
                </ul>
