      ...
      <div className="relative p-6">
        ...
        <div className="pt-4 border-t border-gray-200">
          <a
            ...
            className="w-full flex items-center justify-center gap-2 bg-[#15297c] text-white rounded-lg hover:bg-[#0f1f5a] transition-colors duration-300 font-medium group"
          >
            Solicitar Orçamento
