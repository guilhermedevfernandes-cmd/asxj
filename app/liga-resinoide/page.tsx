...
const resinoideProducts: Product[] = [
  {
    code: "EDA 2021",
    title: "EDA 2021",
    description: "Cristal friável, geralmente imperfeito e irregular, com superfícies ásperas e predominantemente translúcido. Adequado para uma ampla variedade de aplicações econômicas e pouco exigentes em ligante resinoide, tanto para a retificação úmida quanto seca de carboneto de tungstênio.",
    strength: "Friável",
    features: [
      "Cristal friável",
      "Superfícies ásperas",
